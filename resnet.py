...
caltech_dir = "/content/gdrive/MyDrive/images_s"
...
np.save("/content/gdrive/MyDrive/image_sdata_gen4.npy", xy)
...
X_train, X_test, y_train, y_test = np.load('/content/gdrive/MyDrive/image_sdata_gen.npy',allow_pickle = True)
print(X_train.shape)
...
model.save('/content/gdrive/MyDrive/place_rec.h5')
