...
function backgroundFunc(x) {
  if (x == 0) {
    container.style.background =
      "linear-gradient(90deg, #2196f3 0%, rgb(31, 197, 181) 100%)";
  } else if (x == 1) {
    container.style.background =
      "linear-gradient(90deg, #47eaff 0%, #fff498 100%)";
  } else if (x == 2) {
    container.style.background =
      "linear-gradient(90deg, #ffcf86 0%, #ff5a4e 100%)";
  } else if (x == 3) {
    container.style.background =
      "linear-gradient(90deg, #b085fd 0%, rgb(249 195 191) 100%)";
  }
}
